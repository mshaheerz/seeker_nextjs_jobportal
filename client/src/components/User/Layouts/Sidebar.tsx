...
function Sidebar({userDetails}:any) {
  ...
  return (
    ...
    <div className="text-[#d9d9d9] flex item-center justify-center hoverAnimation xl:ml-auto xl:-mr-5 mt-auto" onClick={()=>router.push('/profile')}>
      ...
      <img src={userDetails?.image ? userDetails?.image :'https://lh3.googleusercontent.com/ogw/AAEL6sgG2UNiqo6FhnY0vomhQbCo9WLthbflYev4z7iaBg=s32-c-mo'} alt="loading" className="h-10 w-10 rounded-full xl:mr-2.5" />
